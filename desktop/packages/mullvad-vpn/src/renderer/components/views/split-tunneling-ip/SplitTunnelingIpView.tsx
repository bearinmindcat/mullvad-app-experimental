...
export function SplitTunnelingIpView() {
  ...
  const includedTitle = <Cell.SectionTitle>Included IPs</Cell.SectionTitle>;
  const excludedTitle = <Cell.SectionTitle>Excluded IPs</Cell.SectionTitle>;
  ...
  return (
    <View backgroundColor="darkBlue">
      <BackAction action={pop}>
        <NavigationContainer>
          <AppNavigationHeader title="Split Tunneling (IP)" />

          <SettingsNavigationScrollbars fillContainer>
            <View.Content>
              <SettingsHeader>
                <HeaderTitle>Split Tunneling (IP)</HeaderTitle>
                <HeaderSubTitle>
                  Choose the IPs you want to exclude from the VPN tunnel. Really only made this
                  for Tailscale, but you can use it for other stuff too.
                </HeaderSubTitle>
              </SettingsHeader>
              ...
              <StyledSearchContainer>
                <StyledSearchInput
                  ...
                  onKeyDown={onKeyDown}
                  placeholder="Type IP eg. 100.64.0.0/10..."
                />
                <StyledAddIcon
